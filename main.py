...
app_label = Label(frame_tela,text='', width=16,height=2 ,padx=7, relief=FLAT,anchor="e" ,justify=RIGHT, font=('Ivy 18'), bg=cor3, fg=cor2)
...
b_7 = Button(frame_corpo,text="*",width=5,height=2,bg=cor4,font=('Ivy 13 bold'),relief=RAISED,overrelief=RIDGE )
...
b_11 = Button(frame_corpo,text="-",width=5,height=2,bg=cor4,font=('Ivy 13 bold'),relief=RAISED,overrelief=RIDGE )
...
b_15 = Button(frame_corpo,text="+",width=5,height=2,bg=cor4,font=('Ivy 13 bold'),relief=RAISED,overrelief=RIDGE )
